          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
                With over <strong className="text-foreground font-semibold">6+ years of combined experience</strong> in web application development, graphic branding, and Unity game creation, we formed Team CCH to offer unified, full-service technology solutions.
              </p>
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 space-y-3">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gradient">Why Partner With Team CCH?</h2>
